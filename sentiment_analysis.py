...
print("Kennedy's average sentiment was ", sum(k_len) / len(k_len))
print("Kennedy's median sentiment was", np.median(k_len))
print("Kennedy's std dev was", np.std(k_len))
print("max: ", max(k_len))
print("min: ", min(k_len))

print("Reagan's sentiments were: ")
print("Reagan's average sentiment was ", sum(r_len) / len(r_len))
print("Reagan's median sentiment was", np.median(r_len))
...
# ax1.bar(speech_numbers,kennedy_compounds)
# plt.show()

# fig2 = plt.figure()
# ax2 = fig2.add_axes([0,0,1,1])
# ax2.bar(speech_numbers,reagan_compounds)
# plt.show()

# plt.plot(speech_numbers, kennedy_compounds)
# plt.grid()
# plt.show()

# plt.plot(speech_numbers, reagan_compounds)
# plt.grid()
# plt.show()
